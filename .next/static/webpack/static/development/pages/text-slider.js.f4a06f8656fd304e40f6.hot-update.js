...
function (_React$PureComponent) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(SphereSlider, [{
    ...
    value: function componentDidMount() {
      ...
      this.gui.add(this.config, 'offsetY').min(-1).max(1).step(0.001);
      ;
      this.gui.add(this.config, 'x').min(-this.width).max(this.width).step(0.001);
      this.gui.add(this.config, 'y').min(-this.height).max(this.height).step(0.001);
    }
  }, {
    key: "render",
...
//# sourceMappingURL=text-slider.js.f4a06f8656fd304e40f6.hot-update.js.map