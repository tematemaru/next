...
function (_React$PureComponent) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(SphereSlider, [{
    ...
    value: function componentDidMount() {
      ...
      ;
      this.gui.add(this.config, 'x').min(-this.width).max(this.width).step(1);
      this.gui.add(this.config, 'y').min(-this.height).max(this.height).step(1);
    }
  }, {
    key: "render",
...
//# sourceMappingURL=text-slider.js.7bbf4b89a10359036992.hot-update.js.map